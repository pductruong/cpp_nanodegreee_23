...
ChatBot::ChatBot(const ChatBot &chatbot) {
  std::cout << "Copy constructor of instance " << &chatbot << " to instance "
            << this << std::endl;
...
ChatBot &ChatBot::operator=(const ChatBot &chatbot) {
  std::cout << "Assignment constructor of instance " << &chatbot
...
ChatBot::ChatBot(ChatBot &&chatbot) {
  std::cout << "Move constructor instance " << &chatbot << " to instance "
            << this << std::endl;
...
ChatBot &ChatBot::operator=(ChatBot &&chatbot) {
  std::cout << "Move Assignment constructor of instance " << &chatbot
            << " to instance " << this << std::endl;
